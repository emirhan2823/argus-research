...
TradingView'daki HARSI indikatoru. Ekran goruntusundeki parametreler:
`HARSI * 14 1 ohlc4 7 3 3 14 80 20 30 -20 -30`

## Pine Script Kodu

(Asagiya TradingView'dan HARSI Pine Script kodunu yapistiriniz)
...
|-----------|-------|----------|
| RSI Period | 14 | RSI hesaplama periyodu |
| Source | ohlc4 | Kaynak veri tipi |
| Smoothing | 1 | Smoothing factor |
| ... | ... | (Pine kodundan tamamlanacak) |

## Sinyal Mantigi

(Pine Script kodu yapistirildiktan sonra ben dolduracagim)

- LONG sinyal kosullari: ...
- SHORT sinyal kosullari: ...

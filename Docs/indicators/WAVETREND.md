...
TradingView'daki WaveTrend indikatoru. Mean-reversion ve momentum crossover
sinyalleri icin kullanilir.

## Pine Script Kodu

(Asagiya TradingView'dan WaveTrend Pine Script kodunu yapistiriniz)
...
|-----------|-------|----------|
| Channel Length (n1) | 10 | HLC3 EMA periyodu |
| Average Length (n2) | 21 | CI EMA periyodu |
| Overbought Level 1 | 60 | OB zonu |
| Oversold Level 1 | -60 | OS zonu |

## Sinyal Mantigi

(Pine Script kodu yapistirildiktan sonra ben dolduracagim)

- LONG: WT1 oversold + WT1 crosses above WT2
- SHORT: WT1 overbought + WT1 crosses below WT2
